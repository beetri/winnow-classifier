...
L'aggiunta delle feature è un punto delicato di un sistema di classificazione e per tale motivo va analizzando ponderatamente compatibilmente col dominio che viene trattato dal classificatore.
Il dominio delle domande è formato per l'appunto da domande, le quali per loro propria natura sono ``compattate'' in media in una certa finestra di lunghezza comunque molto piccola.
