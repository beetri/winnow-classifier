...
% introdotto male parlare degli altri classificatori %
Il tempo di training di un classificatore off-line è solitamente maggiore, se confrontato con un classificatore online, problema affrontato ad esempio anche in~\cite{Habib}.
...
Ritorniamo al primo modulo della pipeline. Poiché le domande sono per loro natura brevi possiamo arricchirne il contenuto aggiungendo delle Feature, questo è il lavoro svolto dal modulo denominato Feature Adder.
