...
Sebbene sia possibile create classificatori con regole euristiche costruite ad hoc~\cite{Voorhees01}, tale approccio 
...
All'apparenza un classificatore OnLine offre più vantaggi ma come spesso accade ai ``pro'' vanno sommati dei ``contro'', che in questo caso ricadono sulle prestazioni del classificatore; un classificatore on-line è tipicamente peggiore di un classificatore off-line.
