...
Entriamo nella fase realizzativa, la piattaforma scelta è quella di WEKA principalmente perchè ci offre la possibilità di utilizzare e poter paragonare agilmente l'efficacia del classificatore con gli altri già implementati nello strumento.
