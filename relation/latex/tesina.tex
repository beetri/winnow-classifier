...
\end{itemize}
La macchina di test ha el seguenti caratteristiche principali:
\begin{itemize}
...
L'algoritmo di winnow realizzato ha la seguente architettura: ad ogni ``classe'' da classificare è associata una collezione di così detti ``esperti'', ogni esperto è relativo ad sola parola, ovvero un esperto viene interpellato quando la parola associata ad esso è presente in una domanda.
